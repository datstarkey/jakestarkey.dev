        ...
        <div className="about-me">
          <div className="about-text">
            ...
            <p>
              ...
              relevant technolgies through self teaching.
              <br /> <br />
              This developed into a wide understanding of web and app development, which I futher expanded into deployment and DevOps.
              <br />
              <br />
